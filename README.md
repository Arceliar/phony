...
1. An extremely small code base consisting of about 55 SLOC, not counting comments/tests/examples, which only depends on Go built-ins and the `sync` package from the standard library.
